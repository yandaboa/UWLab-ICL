...
# Environment for training with depth observations
gym.register(
    id="OmniReset-Ur5eRobotiq2f85-RelCartesianOSC-Depth-Train-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.depth_training_cfg:Ur5eRobotiq2f85DepthTrainingCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_cfg:Base_PPORunnerCfg",
    },
)